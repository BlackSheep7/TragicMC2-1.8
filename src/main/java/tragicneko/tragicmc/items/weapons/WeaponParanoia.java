...
public class WeaponParanoia extends EpicWeapon {
	...
	public ItemStack onItemRightClick(ItemStack par1ItemStack, World par2World, EntityPlayer par3EntityPlayer)
	{
		...
		{
			if (canUseAbility(doom, TragicConfig.doomAbilityCost[22]) && getStackCooldown(par1ItemStack) == 0 && TragicConfig.doomAbility[22])
			{
				for (int l = 0; l < 5; l++)
				{
		...
		{
			if (canUseAbility(doom, TragicConfig.doomAbilityCost[23]) && getStackCooldown(par1ItemStack) == 0 && TragicConfig.doomAbility[23])
			{
