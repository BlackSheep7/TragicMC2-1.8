...
public class ModelMechaExo extends ModelBase
{
	...
	public ModelMechaExo()
	{
		...
		this.partArray = new ModelRenderer[] {body, rightLeg, leftLeg, rightShoulder, leftShoulder};
	}
	...
	{
		this.leftShoulder.rotateAngleX = -0.65F + -0.95F * this.simplifyAngle(entity.ticksExisted, 20.0F) * f1;
		this.rightShoulder.rotateAngleX = -0.65F + 0.95F * this.simplifyAngle(entity.ticksExisted, 20.0F) * f1;
		this.leftShoulder.rotateAngleZ = -0.45F + -0.45F * this.simplifyAngle(entity.ticksExisted, 20.0F) * f1;
		this.rightShoulder.rotateAngleZ = 0.45F + 0.45F * this.simplifyAngle(entity.ticksExisted, 20.0F) * f1;
		
		this.leftLeg.rotateAngleX = -0.65F + -0.95F * this.simplifyAngle(entity.ticksExisted, 20.0F) * f1;
		this.rightLeg.rotateAngleX = -0.65F + 0.95F * this.simplifyAngle(entity.ticksExisted, 20.0F) * f1;
		this.leftLeg.rotateAngleZ = -0.45F + -0.45F * this.simplifyAngle(entity.ticksExisted, 20.0F) * f1;
		this.rightLeg.rotateAngleZ = 0.45F + 0.45F * this.simplifyAngle(entity.ticksExisted, 20.0F) * f1;
