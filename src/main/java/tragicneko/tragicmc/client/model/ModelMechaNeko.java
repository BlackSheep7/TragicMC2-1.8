...
public class ModelMechaNeko extends ModelBiped
{
	private ModelRenderer leftEar;
	private ModelRenderer rightEar;
	private ModelRenderer tail;
	private ModelRenderer wrench;

	public ModelMechaNeko()
	{
		textureWidth = 64;
		textureHeight = 64;
		...
		wrench = new ModelRenderer(this, 36, 52);
		wrench.addBox(-1.5F, 7F, -7.5F, 1, 1, 10);
		bipedRightArm.addChild(wrench);
		ModelRenderer wrenchBit = new ModelRenderer(this, 36, 52);
		wrenchBit.addBox(-1.5F, 6F, -9.5F, 1, 1, 3);
		wrench.addChild(wrenchBit);
		ModelRenderer wrenchBit2 = new ModelRenderer(this, 36, 52);
		wrenchBit2.addBox(-1.5F, 8F, -9.5F, 1, 1, 3);
		wrench.addChild(wrenchBit2);
		ModelRenderer wrenchBit3 = new ModelRenderer(this, 36, 52);
		wrenchBit3.addBox(-1.5F, 6F, 1.5F, 1, 1, 3);
		wrench.addChild(wrenchBit3);
		ModelRenderer wrenchBit4 = new ModelRenderer(this, 36, 52);
		wrenchBit4.addBox(-1.5F, 8F, 1.5F, 1, 1, 3);
		wrench.addChild(wrenchBit4);
	...
	public void render(Entity entity, float f, float f1, float f2, float f3, float f4, float f5)
	{
		...
		if (entity instanceof EntityNeko) wrench.showModel = !((EntityNeko) entity).isProperDate() && !entity.isRiding();
	...
	public void setRotationAngles(float f, float f1, float f2, float f3, float f4, float f5, Entity entity)
	{
		...
		if (!neko.isProperDate() && neko.getAttackTime() > 0)
		{
			this.bipedRightArm.rotateAngleX = 1.85F * this.simplifyAngle(neko.getAttackTime(), 10.0F);
			this.bipedRightArm.rotateAngleZ = 0.236F - 0.95F * this.simplifyAngle(neko.getAttackTime(), 10.0F);
		}
