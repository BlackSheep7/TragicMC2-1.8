...
public class RenderDimensionalAnomaly extends Render {
	...
	public RenderDimensionalAnomaly(RenderManager rm)
	{
		super(rm);
	...
	public void doRender(Entity p_76986_1_, double p_76986_2_, double p_76986_4_, double p_76986_6_, float p_76986_8_, float p_76986_9_) {
		this.doRender((EntityDimensionalAnomaly) p_76986_1_, p_76986_2_, p_76986_4_, p_76986_6_, p_76986_8_, p_76986_9_);
	}

	public void doRender(EntityDimensionalAnomaly entity, double par2, double par3, double par4, float par5, float par6) {
		float f = 1.425F;
		float f1 = 0.025F;
		GL11.glPushMatrix();
