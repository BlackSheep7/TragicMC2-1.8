...
public class ConfigHardcore extends TragicNewConfig {
	...
	public static void load(Configuration config)
	{
		...
		registerObject(s, clamp(prop.getInt(0), 1, 250));
		...
		amuletEffects[++m] = prop.getBoolean(false);
		...
		registerObject(s, clampPositive(prop.getInt(10)));
