...
public class ConfigMobsOnly extends TragicNewConfig {
	...
	public static void load(Configuration config)
	{
		...
		registerObject("allowNonMobItems", false);
		registerObject("allowNonMobBlocks", false);
		registerObject("allowNetwork", false);
		registerObject("allowRecipes", false);
		registerObject("allowSurvivalTab", false);
		...
		prop.comment = "Can you respawn in the Synapse or wll you be forced back to the Overworld?";
		dimensionConfig[++m] = prop.getBoolean(true);
