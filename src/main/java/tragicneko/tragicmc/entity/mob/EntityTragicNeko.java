...
public class EntityTragicNeko extends TragicMob {
	...
	public static final Predicate nekoTarget = new Predicate() {
		...
		public boolean canApply(Entity entity) {
			return entity instanceof EntityTragicNeko && !((EntityTragicNeko) entity).isReleased();
		}
	};

	public final EntityAIBase attackOnCollide = new EntityAIAttackOnCollide(this, EntityLivingBase.class, 1.0D, true);
	public final EntityAIBase hurtByNekos = new EntityAIHurtByTarget(this, true, EntityTragicNeko.class);
	...
	public final EntityAIBase targetUnreleasedNekos = new EntityAINearestAttackableTarget(this, EntityTragicNeko.class, 0, true, false, nekoTarget);
	...
	private void setReleased(boolean flag) {
	...
	public void releaseNeko(EntityPlayer player) {
		...
		{
			player.addChatComponentMessage(new ChatComponentText("OVERRIDE DEVICE FAILED. CANNOT INSTANTIATE DEVICE IF ONE IS ALREADY ACTIVE. REVERTING TO FROZEN STATE."));
			...
			{
				Item[] items = new Item[] {TragicItems.Starstruck, TragicItems.Faultless, TragicItems.Transmissions,
	...
	public void onLivingUpdate()
	{
		...
		if (this.isReleased() && this.getAttackTarget() != null && this.getAttackTarget() instanceof EntityTragicNeko && ((EntityTragicNeko) this.getAttackTarget()).isReleased())
		{
			this.setAttackTarget(null);
		}
