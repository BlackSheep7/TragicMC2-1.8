...
public class TragicAchievements {
	...
	public static Achievement thanks = (Achievement) new Achievement("tragicmc.achievement.thanks", "tragicmc.thanks", offsetX, offsetZ, TragicItems.NekoNekoWand, (Achievement) null).registerStat().setSpecial().initIndependentStat();
	...
	//random achievements
	public static Achievement goldenSushi = (Achievement) new Achievement("tragicmc.achievement.goldenSushi", "tragicmc.goldenSushi", -10 + offsetX, -14 + offsetZ, TragicItems.GoldenSushi, null).registerStat().initIndependentStat();
	public static Achievement flight = (Achievement) new Achievement("tragicmc.achievement.flight", "tragicmc.flight", -8 + offsetX, -2 + offsetZ, TragicItems.WingsOfLiberation, null).registerStat().initIndependentStat();
	public static Achievement disorientation = (Achievement) new Achievement("tragicmc.achievement.disorientation", "tragicmc.disorientation", -6 + offsetX, -14 + offsetZ, TragicItems.Ash, null).registerStat().initIndependentStat();
	public static Achievement mobStatue = (Achievement) new Achievement("tragicmc.achievement.mobStatue", "tragicmc.mobStatue", -10 + offsetX, -2 + offsetZ, TragicItems.MobStatue, null).registerStat().initIndependentStat();
	public static Achievement challengeScroll = (Achievement) new Achievement("tragicmc.achievement.challengeScroll", "tragicmc.challengeScroll", -8 + offsetX, -14 + offsetZ, TragicItems.ChallengeScroll, null).registerStat().initIndependentStat();
	public static Achievement doomsdayScroll = (Achievement) new Achievement("tragicmc.achievement.doomsdayScroll", "tragicmc.doomsdayScroll", -8 + offsetX, -12 + offsetZ, TragicItems.DoomsdayScroll, null).registerStat().initIndependentStat();
	public static Achievement mineXP = (Achievement) new Achievement("tragicmc.achievement.mineXP", "tragicmc.mineXP", -8 + offsetX, -10 + offsetZ, Items.experience_bottle, null).registerStat().initIndependentStat();
	public static Achievement loot = (Achievement) new Achievement("tragicmc.achievement.loot", "tragicmc.loot", -8 + offsetX, -8 + offsetZ, TragicItems.TungstenBoots, null).registerStat().initIndependentStat();
	public static Achievement loot2 = (Achievement) new Achievement("tragicmc.achievement.loot2", "tragicmc.loot2", -8 + offsetX, -6 + offsetZ, TragicItems.LightHelm, loot).registerStat();
	public static Achievement systemCrash = (Achievement) new Achievement("tragicmc.achievement.systemCrash", "tragicmc.systemCrash", -6 + offsetX, -12 + offsetZ, TragicItems.NanoBots, null).registerStat().initIndependentStat();
	public static Achievement divinity = (Achievement) new Achievement("tragicmc.achievement.divinity", "tragicmc.divinity", -8 + offsetX, -4 + offsetZ, TragicItems.ArchangelFeather, null).registerStat().initIndependentStat();
	public static Achievement useOrb = (Achievement) new Achievement("tragicmc.achievement.useOrb", "tragicmc.useOrb", -10 + offsetX, -4 + offsetZ, TragicItems.CryingObsidianOrb, null).registerStat().initIndependentStat();
	
	//mob achievements
	public static Achievement tragicNeko = (Achievement) new Achievement("tragicmc.achievement.tragicNeko", "tragicmc.tragicNeko", -14 + offsetX, -14 + offsetZ, Blocks.tnt, null).registerStat().setSpecial().initIndependentStat();
	public static Achievement pumpkinhead = (Achievement) new Achievement("tragicmc.achievement.pumpkinhead", "tragicmc.pumpkinhead", -14 + offsetX, -12 + offsetZ, Blocks.pumpkin, null).registerStat().initIndependentStat();
	public static Achievement norVox = (Achievement) new Achievement("tragicmc.achievement.norVox", "tragicmc.norVox", -14 + offsetX, -10 + offsetZ, TragicBlocks.DarkStone, null).registerStat().initIndependentStat();
	public static Achievement psygote = (Achievement) new Achievement("tragicmc.achievement.psygote", "tragicmc.psygote", -14 + offsetX, -8 + offsetZ, TragicItems.DarkParticles, null).registerStat().setSpecial().initIndependentStat();
	public static Achievement sirv = (Achievement) new Achievement("tragicmc.achievement.sirv", "tragicmc.sirv", -14 + offsetX, -6 + offsetZ, Items.clay_ball, null).registerStat().initIndependentStat();
	public static Achievement ragr = (Achievement) new Achievement("tragicmc.achievement.ragr", "tragicmc.ragr", -14 + offsetX, -4 + offsetZ, TragicBlocks.SmoothNetherrack, null).registerStat().initIndependentStat();
	public static Achievement kurayami = (Achievement) new Achievement("tragicmc.achievement.kurayami", "tragicmc.kurayami", -14 + offsetX, -2 + offsetZ, TragicItems.KitsuneAmulet, null).registerStat().setSpecial().initIndependentStat();
	public static Achievement cantTouchThis = (Achievement) new Achievement("tragicmc.achievement.cantTouchThis", "tragicmc.cantTouchThis", -10 + offsetX, -12 + offsetZ, TragicItems.AwakeningStone, null).registerStat().setSpecial().initIndependentStat();
	public static Achievement rewind = (Achievement) new Achievement("tragicmc.achievement.rewind", "tragicmc.rewind", -10 + offsetX, -10 + offsetZ, TragicItems.LunarPowder, null).registerStat().initIndependentStat();
	public static Achievement aegar = (Achievement) new Achievement("tragicmc.achievement.aegar", "tragicmc.aegar", -12 + offsetX, -4 + offsetZ, TragicItems.SynapseCrystal, null).registerStat().initIndependentStat();
	public static Achievement claymation2in1 = (Achievement) new Achievement("tragicmc.achievement.claymation2in1", "tragicmc.claymation2in1", -10 + offsetX, -8 + offsetZ, TragicItems.ClaymationAmulet, null).registerStat().setSpecial().initIndependentStat();
	public static Achievement skultarImmune = (Achievement) new Achievement("tragicmc.achievement.skultarImmune", "tragicmc.skultarImmune", -10 + offsetX, -6 + offsetZ, TragicItems.SkullHelmet, null).registerStat().initIndependentStat();
	public static Achievement minotaurSummon = (Achievement) new Achievement("tragicmc.achievement.minotaurSummon", "tragicmc.minotaurSummon", -12 + offsetX, -2 + offsetZ, TragicItems.Horn, null).registerStat().setSpecial().initIndependentStat();
	public static Achievement seeker = (Achievement) new Achievement("tragicmc.achievement.seeker", "tragicmc.seeker", -12 + offsetX, -14 + offsetZ, TragicItems.BlindingLight, null).registerStat().initIndependentStat();
	public static Achievement harvester = (Achievement) new Achievement("tragicmc.achievement.harvester", "tragicmc.harvester", -12 + offsetX, -12 + offsetZ, Blocks.iron_block, null).registerStat().initIndependentStat();
	public static Achievement lockdown = (Achievement) new Achievement("tragicmc.achievement.lockbot", "tragicmc.lockbot", -12 + offsetX, -10 + offsetZ, Blocks.anvil, null).registerStat().initIndependentStat();
	public static Achievement fusea = (Achievement) new Achievement("tragicmc.achievement.fusea", "tragicmc.fusea", -12 + offsetX, -8 + offsetZ, TragicItems.UnstableIsotope, null).registerStat().initIndependentStat();
	public static Achievement ire = (Achievement) new Achievement("tragicmc.achievement.ire", "tragicmc.ire", -12 + offsetX, -6 + offsetZ, TragicItems.IreNetParticleCannon, null).registerStat().initIndependentStat();
	public static Achievement avris = (Achievement) new Achievement("tragicmc.achievement.avris", "tragicmc.avris", -6 + offsetX, -10 + offsetZ, TragicItems.Ruby, null).registerStat().initIndependentStat();
	...
	public static Achievement tragicNekoDevice = (Achievement) new Achievement("tragicmc.achievement.tragicNekoDevice", "tragicmc.tragicNekoDevice", -4 + offsetX, 10 + offsetZ, TragicItems.NekoMindControlDevice, null).registerStat().initIndependentStat();
	public static Achievement tragicNekoRelease = (Achievement) new Achievement("tragicmc.achievement.tragicNekoRelease", "tragicmc.tragicNekoRelease", -2 + offsetX, 10 + offsetZ, TragicItems.RecaptureSiphon, tragicNekoDevice).registerStat().setSpecial();
	public static Achievement tragicNekoFile = (Achievement) new Achievement("tragicmc.achievement.tragicNekoFile", "tragicmc.tragicNekoFile",-2 + offsetX, 8 + offsetZ, TragicItems.Starstruck, tragicNekoRelease).registerStat();
	public static Achievement tragicNekoInfluence = (Achievement) new Achievement("tragicmc.achievement.tragicNekoInfluence", "tragicmc.tragicNekoInfluence",-2 + offsetX, 12 + offsetZ, TragicItems.NekoInfluencer, tragicNekoRelease).registerStat();
	
	//boss achievements
	public static Achievement apis = (Achievement) new Achievement("tragicmc.achievement.apis", "tragicmc.apis", -12 + offsetX, 2 + offsetZ, TragicItems.PureLight, null).registerStat().initIndependentStat();
	public static Achievement skultar = (Achievement) new Achievement("tragicmc.achievement.skultar", "tragicmc.skultar", -12 + offsetX, 4 + offsetZ, TragicItems.DeathlyHallow, null).registerStat().initIndependentStat();
	public static Achievement kitsunakuma = (Achievement) new Achievement("tragicmc.achievement.kitsunakuma", "tragicmc.kitsunakuma", -12 + offsetX, 6 + offsetZ, TragicItems.KitsuneTail, null).registerStat().initIndependentStat();
	public static Achievement polaris = (Achievement) new Achievement("tragicmc.achievement.polaris", "tragicmc.polaris", -12 + offsetX, 8 + offsetZ, TragicItems.StarPieces, null).registerStat().initIndependentStat();
	public static Achievement empariah = (Achievement) new Achievement("tragicmc.achievement.empariah", "tragicmc.empariah", -10 + offsetX, 2 + offsetZ, TragicItems.EmpariahClaw, null).registerStat().initIndependentStat();
	public static Achievement timeController = (Achievement) new Achievement("tragicmc.achievement.timeController", "tragicmc.timeController", -10 + offsetX, 4 + offsetZ, TragicItems.TimeEssence, null).registerStat().initIndependentStat();
	public static Achievement enyvil = (Achievement) new Achievement("tragicmc.achievement.enyvil", "tragicmc.enyvil", -10 + offsetX, 6 + offsetZ, TragicItems.PureDarkness, null).registerStat().initIndependentStat();
	public static Achievement claymation = (Achievement) new Achievement("tragicmc.achievement.claymation", "tragicmc.claymation", -10 + offsetX, 8 + offsetZ, TragicItems.LivingClay, null).registerStat().initIndependentStat();
