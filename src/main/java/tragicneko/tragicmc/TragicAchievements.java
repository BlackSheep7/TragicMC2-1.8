...
public class TragicAchievements {
	...
	public static Achievement ragr = (Achievement) new Achievement("tragicmc.achievement.ragr", "tragicmc.ragr", -14 + offsetX, -4 + offsetZ, Blocks.fire, null).func_180788_c().initIndependentStat();
