...
public class LoreHelper {
	...
	public static void loadDefaultLores()
	{
		...
		addToLoreMap("tragicmc:overlordHelm", new LoreEntry(new Lore[] {new Lore("And can you offer me proof of your existence? How can you, when neither modern science nor philosophy can explain what life is?", 3),
				...
				new Lore("Your effort to remain what you are is what limits you.", 3), new Lore("I mean, who knows what's inside your head. Have you ever seen your own brain?", 3),
				new Lore("I thought what I'd do is pretend I was one of those deaf-mutes.", 3), new Lore("Stand alone complex.", 3),
				...
				new Lore("KANEDAAAAAAAAA!", 3), new Lore("TESTSUOOOOOOOO!", 3), new Lore("Human curiosity.", 0)}, 
				new EnchantEntry[] {
